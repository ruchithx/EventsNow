...
interface PresonDetailsBar {name:string,email: string}
...
console.log("edit done");
  ...
  return (
    ...
    <div className=" mx-10 my-4 item-center  bg-[#D9D9D9] w-full col-span-2 grid grid-cols-12 items-center  rounded-[5px]">
      ...
      <div className="text-base font-light col-span-6	">
        {email}
      </div>
      <div className="col-span-1 grid ">
        <button onClick={editDetails} className="bg-[#4E5381] hover:bg-[#5E659F] h-[34px] justify-self-end rounded-[5px] w-[116px]">
