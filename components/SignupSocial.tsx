      ...
      <div className="grid grid-cols-2 justify-items-center">
        <button className="mx-3 mb-3 mt-4 justify-self-end hover:bg-custom-lightorange rounded-[10px] border-solid border-[#D7CFC7] border-[1px]">
          <div className="flex">
            ...
            >
              <g id="Social Icons" clip-path="url(#clip0_256_613)">
                <path
                  id="Vector"
        ...
        <button className="mx-3 mb-3 mt-4 justify-self-start hover:bg-custom-lightorange rounded-[10px] border-solid border-[#D7CFC7] border-[1px]">
          <div className="flex">
            <svg
              className="self-center my-1 ml-4 mr-3"
              width="36"
        ...
        >
          <div className="flex">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g id="Social Icons" clip-path="url(#clip0_256_616)">
                <path
                  id="Vector"
