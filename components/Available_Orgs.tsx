...
export default function Available_Orgs({
  ...
  const value =
    OrgName.length > 10
      ? "w-[250px] md:w-[250px] lg:w-[680px]"
      : "lg:w-[680px] w-72 md:w-[250px]";
  return (
    <div
      className={`grid grid-cols-1 lg:grid-cols-11 md:grid-cols-1  sm:m-6  ${value} h-auto md:h-auto lg:h-32 rounded-lg bg-[#D9D9D9] mt-6 ms-6 sm:ms-10 lg:ms-0 md:ms-20`}
    >
      ...
      <div className="col-span-full md:col-span-2 lg:col-span-3 flex justify-center sm:justify-start pl-8 sm:mt-0 md:mt-4 lg:mt-0">
        <div className=" justify-auto flex flex-col  md:justify-center lg:justify-auto ">
          ...
          <div className="flex flex-row">
            <button
              onClick={handleClick}
              className=" w-20 h-[30px] rounded-3xl bg-[#B63535] mt-2 mr-4 md:mr-0 lg:mr-4 "
            >
            ...
            <button
              onClick={() => deny()}
              className=" w-20 h-[30px] rounded-3xl bg-[#4E8171] mt-2 ml-0 md:ml-6 lg:ml-0 "
            >
              <div className="flex justify-center text-white text-sans font-medium ">
                Details
              </div>
      ...
      <div
        className={`col-span-full md:col-span-full lg:col-span-5  mb-3 sm:mb-0 ms-3 lg:ms-0 md:ms-0 `}
      >
        <div className="lg:w-64 w-48 md:w-48  h-28 md:h-28 lg:h-24 rounded bg-[#F4F4F4] mt-2 md:mt-4 lg:mt-3.5 ml-0 md:ml-6 lg:ml-8 mb-0 md:mb-4 lg:mb-0">
